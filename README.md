...
For the rest of the code, check the [SQL_queries.sql]([https://github.com/Princekrampah/WalmartSalesAnalysis/blob/master/SQL_queries.sql](https://github.com/iguptashubham/walmart-eda/blob/main/walmart_eda.sql)) file
